...
<html lang="en">
	<head>
	    ...
	    <title>Study Planner | Signi-in | Signup</title>
...
return true;
    	...
    	<script>
			// Js function to check the availability of a user's email adrress
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Create Your New Study Account.</p>
